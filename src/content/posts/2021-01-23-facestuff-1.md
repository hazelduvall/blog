...
Currently, [the application](https://github.com/hazelduvall/facestuff):
...
- [A Custom GUI Library](https://github.com/hazelduvall/ACGL) built on top of SDL spawns the two threads to do Live2D rendering and OpenCV maths at the same time, as well as controlling the layout of the scene.
...
<figure class="block-image">
  <img style="width: 80%" src="https://www.hazelduvall.dev/static/live2D_OpenCV_SDL.png" alt="A console showing debug info on the left, and an SDL frame showing a Live2D model on the right. The background of the frame is the screen this is displayed on, causing it to recurse for a few iterations." title="Pretty trippy, huh?" />
