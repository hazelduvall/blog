...
```
C:> runas /user:hduvall@ANDREW.CMU.EDU cmd
...
![Screenshot of SSH using Kerberos to automatically log in to CMU servers](https://www.hazelduvall.dev/static/ssh-using-kerberos.png "I can log in without a password now!")
