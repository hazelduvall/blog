...
class. **You can view the paper [here](https://www.hazelduvall.dev/static/f21-10417-project.pdf)**.
...
**TL;DR** [paper here](https://www.hazelduvall.dev/static/f21-10417-project.pdf), didn't get good results
but learned a lot.
