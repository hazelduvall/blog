...
[I was fed up with Hakyll](2022-12-29-i-dont-actually-like-hakyll-that-much.html), so I've switched my site to use a new blogging framework, [Astro](https://astro.build/).
...
```bash
aws s3 sync --delete _site/ s3://www.hazelduvall.dev/
```
