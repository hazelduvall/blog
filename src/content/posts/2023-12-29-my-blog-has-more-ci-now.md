...
[online dashboard](https://developer.mend.io/github/hazelduvall/blog), or, and this
is the part I found really cool, through the [Github UI
itself](https://github.com/hazelduvall/blog/issues/4) via (presumably) some fun
webhook hacks.
