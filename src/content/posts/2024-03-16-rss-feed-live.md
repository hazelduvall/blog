...
My blog now has an [RSS Feed](/blog/rss.xml)!. Again. After the one that came with Hakyll got removed in [the upgrade to Astro](2023-10-22-new-blog-framework.html), and I had to update to [@astrojs/rss](https://docs.astro.build/en/guides/rss/). I also:
