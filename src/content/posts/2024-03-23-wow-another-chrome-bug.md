...
So in one of my [previous posts](2023-12-28-i-think-i-found-a-webkit-bug.html),
I outlined how Chrome had a rendering bug where it did not properly mask
anti-aliasing pixels under certain complex CSS `mask` conditions. And wouldn't
you know it, right as I publish an [update](2024-03-15-working-around-a-webkit-bug.html)
to that post, I find yet _another_ Chrome rendering bug at work.
...
<div class="outer">
  ...
  <div class="inner container">
    <img class="round" src="https://www.hazelduvall.dev/static/2024-03-20/dog.jpg">
  </div>
</div>
</p>
...
<figure>
<video controls src="https://www.hazelduvall.dev/static/2024-03-20/bug.mov" style="width: 100%">
