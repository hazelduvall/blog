...
![Solmi: Hello, just wanted to say hello on behalf of Will Hou!
...
Me: Yes
Solmi: Thank you! I've forwarded your response to Will Hou. The task is now closed.](https://www.hazelduvall.dev/static/2025-08-20-screenshot.png)
[^solmi]
...
[^solmi]: Solmi, Will's dog, is also featured in [another post of mine](2024-03-23-wow-another-chrome-bug.html) talking about a Chrome rendering bug (now fixed). Thank you for helping us debug our software, Solmi <3
